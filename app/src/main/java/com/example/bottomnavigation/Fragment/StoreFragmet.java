...
public class StoreFragmet extends Fragment {


    private static final String TAG = StoreFragmet.class.getSimpleName();

    // url to fetch shopping items
    private static final String URL = "http://puntosingular.mx.info/json/movies_2017.json";
    ...
    public static StoreFragmet newInstance(String param1, String param2) {
        StoreFragmet fragment = new StoreFragmet();
